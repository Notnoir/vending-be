...
- **Database Integration** dengan MySQL untuk data persistence
...
- **MQTT Integration** (opsional - bisa di-disable untuk testing)

## 📋 Prerequisites

- Node.js 16+
- MySQL 5.7+ atau MariaDB 10.3+
- MQTT Broker (opsional - untuk integrasi hardware)
...
# MQTT (Optional - akan di-skip jika tidak ada)
...
### Mode 1: Testing/Development (Tanpa Hardware)

- ✅ Database: MySQL
- ❌ MQTT: Disabled (mock functions)
...
### Mode 2: Production (Dengan Hardware)
